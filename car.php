    ...
    <div class="card">
        ...
        <div class="mt-3">
            ...
            <div class="tuning-grid">
                ...
                <?php $hasDriveType = !empty($car['drivetype']); ?>
                <div class="tuning-item <?= $hasDriveType ? 'active' : 'inactive' ?>">🚗 Hajtástípus <?= $hasDriveType ? htmlspecialchars($car['drivetype']) : 'Nincs megadva' ?></div>
